...
export const metadata: Metadata = {
	...
	metadataBase: new URL(APP_CONFIG.SITE_URL || "https://kjc.com"),
	openGraph: {
		type: "website",
		locale: "vi_VN",
...
export default async function RootLayout({ children }: RootLayoutProps) {
	return (
		...
		>
			<body
				className={`${geistRoboto.variable} ${geistSans.variable} antialiased flex flex-col min-h-screen w-full bg-gradient-to-br from-red-100 via-white to-teal-100 dark:from-red-950 dark:via-black dark:to-teal-950`}
				suppressHydrationWarning
			>
				<Providers>
